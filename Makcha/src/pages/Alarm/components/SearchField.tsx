    ...
    <div className="mt-6 space-y-2">
      ...
      <button
        ...
        className="
          ...
          max-md:h-[50px] max-md:pl-[14px] max-md:pr-[14px]
        "
      >
        ...
        <span className="flex-1 truncate text-left text-sm text-gray-600 dark:text-white/80 max-md:text-[16px] max-md:text-[#5F5F5F]">
          {text}
        </span>

        <Search
          className="h-5 w-5 text-gray-400 dark:text-white/60 max-md:h-6 max-md:w-6"
          strokeWidth={2}
          aria-hidden="true"
        />
      </button>
