        ...
        <div className="fixed inset-0 z-9999 h-dvh w-screen overflow-hidden overscroll-contain flex flex-col bg-white dark:bg-makcha-navy-900">
                    ...
                    <div className="relative flex items-center justify-center">
                        ...
                        >
                            <img
                                src={CloseIcon}
                                alt=""
                                className="h-8 w-8 opacity-70 dark:opacity-80"
                            />
                        </button>
                    </div>
                </div>
            ...
            >
                ...
                <div className="mt-[37px] px-5">
                    <div className="flex h-15.5 items-center rounded-[10px] border border-[#6D6D6D] bg-white px-4 shadow-sm">
                        <input
                            value={query}
                        ...
                        <img
                            src={SearchIcon}
                            alt="검색"
                            className="h-8 w-8 opacity-60 dark:opacity-80"
                        />
                    </div>
                </div>
                        ...
                        <div className="mt-[37px]">
                            ...
                            >
                                <img
                                    src={MapPinIcon}
                                    alt="현위치"
                                    className="h-5 w-5 opacity-70 dark:opacity-80"
                                />
                                <span>현위치</span>
                            </button>
